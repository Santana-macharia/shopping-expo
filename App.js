...
import FaceFilter from './screens/FaceFilter';
	...
	return(
		<Drawer.Navigator drawerContent={props => <Sidebar {...props} />}>
			...
			<Drawer.Screen name="ProfileSettings" component={ProfileSettingsNavigator} options={{
			 ...
			 <Drawer.Screen name="NearByPeople" component={NearByPeopleNavigator} 
				options={{
					drawerIcon:() =>(
			...
			/>
			 <Drawer.Screen name="FaceFilter" component={FaceFilterNavigator} 
				options={{
					drawerIcon:() =>(
						<MaterialIcons name="flare" size={24} color="black" />
					)
				}}
			/>
...
const NearByPeopleNavigator = ({navigation}) =>{

	return (
		<NearByPeopleStack.Navigator >
			<NearByPeopleStack.Screen name="NearByPeople" component={NearByPeople} options={{
				headerRight: () => 
				(	
				<TouchableOpacity style={{margin: 10}} onPress={() => navigation.openDrawer()}>
					<Entypo name="menu" size={28} color="black" />
...
const FaceFilterNavigator = ({navigation}) =>{

	return (
		<FaceFilterStack.Navigator >
			<FaceFilterStack.Screen name="FaceFilter" component={FaceFilter} options={{
				headerRight: () => 
				(	
				<TouchableOpacity style={{margin: 10}} onPress={() => navigation.openDrawer()}>
					<Entypo name="menu" size={28} color="black" />

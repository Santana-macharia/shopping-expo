...
import facemask from '../../photos/mask.png'; 
...
const faces=[{ uri: "https://i.postimg.cc/HWRzs7Yy/Untitled-1-02.png" },
              {uri: "https://i.postimg.cc/T2zjXM0j/Untitled-1-03.png" },
              {uri: "https://i.postimg.cc/s2j6m8w5/Untitled-1-04.png" },
              {uri: "https://i.postimg.cc/L6D7gLty/Untitled-1-05.png" },
              {uri: "https://i.postimg.cc/Zq860F3n/Untitled-1-06.png" },
              { uri: "https://i.postimg.cc/9FFPJFNM/Untitled-1-01.png" }];

export default class FaceFilter extends React.Component {
  ...
  onFacesDetected = ({ faces }) => {
    this.setState({ faces });
    if(faces.length>0){
      if(faces[0].leftEyeOpenProbability<0.7 && faces[0].rightEyeOpenProbability<0.7) {
        console.warn("","Closed!");
      }else {
        console.log("","Open!");
      }
  ...
  renderMask({bounds,faceID,rollAngle,yawAngle,leftEyePosition,rightEyePosition,leftEarPosition,rightEarPosition,leftCheekPosition,rightCheekPosition,leftMouthPosition,mouthPosition,rightMouthPosition,noseBasePosition,bottomMouthPosition}){
  
    // const image = { uri: "https://i.postimg.cc/mD9JPBgV/mask.png" };
  ...
  style={[
    ...
    <View style={styles.container}>
        <ImageBackground source={faces[1]} style={styles.image}>
              </ImageBackground>
      </View>
  ...
  renderMasks = () => (
    <View style={styles.facesContainer} pointerEvents="none">
      {this.state.faces.map(this.renderMask)}
    </View>
  );
...
<ScrollView horizontal={true}>
    ...
    <Image style={{ width: 200, height: 200 }} uri="https://i.postimg.cc/9Fwx1mfy/Untitled-11-01.png" />
  ...
  renderCamera = () => (
    <View style={{ flex: 1 }}>
     ...
     {this.state.faceDetecting&&this.renderMasks()}
  ...
  render() {
    ...
    //const content = this.state.showGallery
      // ? this.renderGallery()
      // : cameraScreenContent;
    return <View style={{flex:1}}>{this.renderCamera()
